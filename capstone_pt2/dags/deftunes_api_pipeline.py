...
DATA_BUCKET_NAME = "de-c4w4a2-637423389266-us-east-1-data-lake"
# replace `<SCRIPTS-BUCKET>` with the ScriptsBucket value
SCRIPTS_BUCKET_NAME = "de-c4w4a2-637423389266-us-east-1-scripts"
# replace `<API-ENDPOINT>` with the APIEndpoint value
API_URL = "ec2-44-194-198-253.compute-1.amazonaws.com"
...
def deftunes_pipeline():
    ...
    dq_check_users_job = GlueDataQualityRuleSetEvaluationRunOperator(
        ...
        role="arn:aws:iam::637423389266:role/de-c4w4a2-glue-role",
